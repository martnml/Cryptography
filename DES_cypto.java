//@Copyrights : MIT All Rights are reserver 2022 
...
//---------------------Decryption function-----------------------
    ...
    public static void main(String args[])
    {
     ...
     System.out.println("enter text to generate the code : ");

     String text =sc.nextLine();
        //String text = "243456ABCD132536";
        String key = "AABB09182736CCDD";

        DES cipher = new DES();

        System.out.println("the original text :"+cipher.hextoBin(text));
